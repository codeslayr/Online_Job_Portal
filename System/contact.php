					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> 97, <br/> Brigade Road, <br/>Bangalore</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:naazadiba849@gmail.com">naazadiba849@gmail.com</a>
								</li>
								<li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											...
											<p>Nightingale Jobs is a job portal, online job management system developed for posting jobs and providing jobs.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Address : 97, Brigade Road, Brigade Road,Bangalore</p>
								<p>Email : <a href="mailto:naazadiba849@gmail.com@gmail.com">naazadiba849@gmail.com</a></p>
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by Group 10</a></li>
								</ul>
